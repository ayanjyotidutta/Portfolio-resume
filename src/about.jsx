    ...
    <section className="section container" id="about">
      ...
      <div className="about-grid">
        <div className="about-copy">
          ...
          <Reveal delay={120}>
            <p>
              Then I started <em>coding</em>. SQL, Python, HTML, CSS, JavaScript. I use generative AI daily —
              not just as a tool, but as a collaborator — to build smarter campaigns, analyze data faster, and
              prototype ideas end-to-end.
            </p>
          </Reveal>
          <Reveal delay={240}>
            <p>
        ...
        <div className="about-facts">
          ...
          <Reveal className="fact" delay={240}><div className="k">Tech</div><div className="v">Python · SQL · HTML/CSS/JS · Power BI</div></Reveal>
          <Reveal className="fact" delay={300}><div className="k">AI Tools</div><div className="v">ChatGPT · Claude · Copilot · Generative AI · LLMs</div></Reveal>
          <Reveal className="fact" delay={360}><div className="k">Open to</div><div className="v">AI Marketing · Brand Strategy · Growth roles</div></Reveal>
        </div>
      </div>
    </section>
  );
